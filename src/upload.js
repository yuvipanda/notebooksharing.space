...
const UploadModal = ({ isOpen, onClose, onOpen }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="xl">
      ...
      <ModalContent>
        <ModalHeader>
          {isUploading ? "Uploading your notebook..." : "Upload your notebook"}
        </ModalHeader>
            ...
            <HStack width="100%">
              <FormControl>
                <Checkbox
                  ...
                  onChange={(ev) => {
                    setIsDiscoverable(ev.target.checked);
                  }}
                >
                  Discoverable
                  <Tooltip
                    label="Make this notebook discoverable by search engines"
                    hasArrow
                  >
                    <span>
                      <Icon
              ...
              <FormControl>
                <Checkbox
                  ...
                  isDisabled={isUploading}
                  onChange={(ev) => {
                    setEnableAnnotations(ev.target.checked);
                  }}
                >
                  Enable annotations
                  <Tooltip
                    label="Enable collaborative annotations on this notebook"
                    hasArrow
                  >
                    <span>
                      <Icon
  ...
  return (
    <>
      <VStack>
        ...
        <small style={{ color: "gray.100" }}>
          Or use the{" "}
          <Link
            style={{ textDecoration: "underline" }}
            isExternal
            href="https://github.com/notebook-sharing-space/nbss-upload"
          >
